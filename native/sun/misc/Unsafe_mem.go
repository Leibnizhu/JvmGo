...
//对应 public native long allocateMemory(long bytes);
...
//对应 public native long reallocateMemory(long address, long bytes);
...
//对应 public native void freeMemory(long address);
...
//}
//
//对应 public native byte getByte(long address);
...
//}
//
//对应 public native void putLong(long address, long x);
