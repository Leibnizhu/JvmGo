...
//查找单个常量
func (self ConstantInfo) getConstantInfo (index uint16) ConstantInfo {
...
//查找字段或方法的名字和描述符
func (self ConstantInfo) getNameAndType(index uint16) (string, string) {
...
//查找类名
func (self ConstantInfo) getClassName(index uint16) string {
